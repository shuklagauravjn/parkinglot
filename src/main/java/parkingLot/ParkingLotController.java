...
public class ParkingLotController {
	...
	public ResponseEntity<String> returnTicket(@RequestParam(value = "slotNumber") String slotNumber) {
		...
		// String message = ticketId+ " accepted. Now slot number "+slotNumber+" is
		// available";
	...
	@ApiResponses(value = { @ApiResponse(code = 500, message = "Issue with ticket issuance", response = String.class),
			@ApiResponse(code = 200, message = "Success", response = String.class) })

	public ResponseEntity<String> issueTicket(@RequestParam(value = "registrationNumber") String registrationNumber,
	...
	@ApiResponses(value = {
			...
			@ApiResponse(code = 200, message = "Success", response = List.class) })
	public ResponseEntity<String> findSlotNumberByRegistrationNumber(
